(function() {
  ...
  headerEl.textContent =
    "This issue body was updated. Click here to display/hide the difference.";
  headerEl.addEventListener("click", () => {
    diffContainerEl.style.display = diffContainerEl.style.display
      ? null
      : "block";
  ...
  const refEl = document.querySelector(
    ".timeline-comment-wrapper .comment .edit-comment-hide"
  );
  document
    .querySelector(".timeline-comment-wrapper .comment")
    .insertBefore(diffEl, refEl);
})();
