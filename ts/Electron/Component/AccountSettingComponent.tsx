...
export default class AccountSettingComponent extends React.Component {
  ...
  _handleSelectGHE() {
    ...
    dialog.querySelector(
      "#configPathPrefix"
    ).parentElement.parentElement.style.display = null;
    dialog.querySelector("#configInterval").value = "10";
    dialog.querySelector("#configHttps").checked = true;
  }
            ...
            <div>
              <div className="select-github-buttons">
                <button
                  ...
                  onClick={this._handleSelectGitHub.bind(this)}
                >
                  GitHub (github.com)
                </button>
                <button
                  className="btn btn-large btn-positive"
                  onClick={this._handleSelectGHE.bind(this)}
                >
                  GitHub Enterprise
                </button>
              </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        placeholder="api.github.com or ghe.example.com"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input
                        id="configWebHost"
                        className="form-control"
                        placeholder="github.com or ghe.example.com"
                      />
                    </td>
                  </tr>
                  <tr>
